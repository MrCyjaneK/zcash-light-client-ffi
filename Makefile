...
APPLE_PLATFORMS = ios-device macos ios-simulator
...
products/libzcashlc.xcframework: $(APPLE_PLATFORMS)
	rm -rf $@
	mkdir -p $@
...
frameworks: $(APPLE_PLATFORMS)
.PHONY: frameworks

$(APPLE_PLATFORMS): %: products/%/frameworks/libzcashlc.framework
.PHONY: $(APPLE_PLATFORMS)
