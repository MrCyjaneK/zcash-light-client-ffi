...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_address_metadata(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_typecodes_for_unified_address_receivers(
    ua: *const c_char,
    len_ret: *mut usize,
) -> *mut u32 {
    let res = catch_panic(|| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_typecodes(data: *mut u32, len: usize) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_is_valid_sapling_extended_spending_key(
    extsk: *const c_char,
    network_id: u32,
) -> bool {
    let res = catch_panic(|| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_is_valid_viewing_key(
    key: *const c_char,
    network_id: u32,
) -> bool {
    let res =
...
///   function call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_is_valid_unified_full_viewing_key(
    ufvk: *const c_char,
    network_id: u32,
) -> bool {
    let res = catch_panic(|| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_spending_key(
    seed: *const u8,
    seed_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_spending_key_to_full_viewing_key(
    usk_ptr: *const u8,
    usk_len: usize,
    network_id: u32,
) -> *mut c_char {
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_address_from_ufvk(
    network_id: u32,
    ufvk: *const c_char,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_address_from_uivk(
    network_id: u32,
    uivk: *const c_char,
    diversifier_index_bytes: *const u8,
) -> *mut ffi::Address {
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_transparent_receiver_for_unified_address(
    ua: *const c_char,
) -> *mut c_char {
    let res = catch_panic(|| {
        let ua_str = unsafe { CStr::from_ptr(ua).to_str()? };
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_sapling_receiver_for_unified_address(
    ua: *const c_char,
) -> *mut c_char {
    let res = catch_panic(|| {
        let ua_str = unsafe { CStr::from_ptr(ua).to_str()? };
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_account_metadata_key_from_parts(
    sk: *const u8,
    chain_code: *const u8,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_account_metadata_key(
    seed: *const u8,
    seed_len: usize,
    account: i32,
    network_id: u32,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_private_use_metadata_key(
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_arbitrary_wallet_key(
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_derive_arbitrary_account_key(
    context_string: *const u8,
    context_string_len: usize,
    seed: *const u8,
    seed_len: usize,
