...
use crate::{ZCASH_zcashlc_string_free, free_ptr_from_vec, free_ptr_from_vec_with, ptr_from_vec};
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_account(ptr: *mut Account) {
    if !ptr.is_null() {
        let account: Box<Account> = unsafe { Box::from_raw(ptr) };
        if !(account.account_name.is_null()) {
            unsafe { ZCASH_zcashlc_string_free(account.account_name) }
        }
        if !(account.key_source.is_null()) {
            unsafe { ZCASH_zcashlc_string_free(account.key_source) }
        }
        if !(account.ufvk.is_null()) {
            unsafe { ZCASH_zcashlc_string_free(account.ufvk) }
        }
        drop(account);
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_ffi_uuid(ptr: *mut Uuid) {
    if !ptr.is_null() {
...
/// Frees an array of [`Uuid`] values as allocated by `ZCASH_zcashlc_list_accounts`.
///
/// # Safety
///
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_accounts(ptr: *mut Accounts) {
    if !ptr.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_binary_key(ptr: *mut BinaryKey) {
    if !ptr.is_null() {
...
/// Frees an array of [`EncodedKey`] values as allocated by `ZCASH_zcashlc_list_transparent_receivers`.
///
/// # Safety
///
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_keys(ptr: *mut EncodedKeys) {
    if !ptr.is_null() {
        let s: Box<EncodedKeys> = unsafe { Box::from_raw(ptr) };
        free_ptr_from_vec_with(s.ptr, s.len, |k| unsafe {
            ZCASH_zcashlc_string_free(k.encoding)
        });
        drop(s);
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_wallet_summary(ptr: *mut WalletSummary) {
    if !ptr.is_null() {
...
/// Frees an array of [`ScanRange`] values as allocated by `ZCASH_zcashlc_suggest_scan_ranges`.
///
/// # Safety
///
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_scan_ranges(ptr: *mut ScanRanges) {
    if !ptr.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_scan_summary(ptr: *mut ScanSummary) {
    if !ptr.is_null() {
        let summary = unsafe { Box::from_raw(ptr) };
        drop(summary);
    }
...
///   (up until [`ZCASH_zcashlc_free_boxed_slice`] is called with it).
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_boxed_slice(ptr: *mut BoxedSlice) {
    if !ptr.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_symmetric_keys(ptr: *mut SymmetricKeys) {
    if !ptr.is_null() {
...
/// Frees an array of `[u8; 32]` values as allocated by `ZCASH_zcashlc_create_proposed_transactions`.
///
/// # Safety
///
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_txids(ptr: *mut TxIds) {
    unsafe { ZCASH_zcashlc_free_symmetric_keys(ptr) };
}
...
/// Frees an array of [`TransactionDataRequest`] values as allocated by `ZCASH_zcashlc_transaction_data_requests`.
///
/// # Safety
///
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_transaction_data_requests(
    ptr: *mut TransactionDataRequests,
) {
    if !ptr.is_null() {
        ...
        free_ptr_from_vec_with(s.ptr, s.len, |req| {
            if let TransactionDataRequest::TransactionsInvolvingAddress { address, .. } = req {
                unsafe { ZCASH_zcashlc_string_free(*address) }
            }
        });
        drop(s);
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_ffi_address(ptr: *mut Address) {
    if !ptr.is_null() {
        let ffi_address: Box<Address> = unsafe { Box::from_raw(ptr) };
        if !(ffi_address.address.is_null()) {
            unsafe { ZCASH_zcashlc_string_free(ffi_address.address) }
        }
        drop(ffi_address);
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_account_metadata_key(ptr: *mut AccountMetadataKey) {
    if !ptr.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_http_response_bytes(ptr: *mut HttpResponseBytes) {
    if !ptr.is_null() {
        let response: Box<HttpResponseBytes> = unsafe { Box::from_raw(ptr) };
        unsafe { ZCASH_zcashlc_string_free(response.version) }
        free_ptr_from_vec_with(response.headers_ptr, response.headers_len, |header| {
            unsafe { ZCASH_zcashlc_string_free(header.name) };
            unsafe { ZCASH_zcashlc_string_free(header.value) };
        });
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_single_use_taddr(ptr: *mut SingleUseTaddr) {
    if !ptr.is_null() {
        let res = unsafe { Box::from_raw(ptr) };
        unsafe { ZCASH_zcashlc_string_free(res.address) }
        drop(res)
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_address_check_result(ptr: *mut AddressCheckResult) {
    if !ptr.is_null() {
        let res = unsafe { Box::from_raw(ptr) };
