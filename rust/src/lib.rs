...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_init_on_load(log_level: *const c_char) {
...
#[unsafe(no_mangle)]
pub extern "C" fn ZCASH_zcashlc_last_error_length() -> i32 {
...
///   pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_error_message_utf8(buf: *mut c_char, length: i32) -> i32 {
    unsafe { ffi_helpers::error_handling::error_message_utf8(buf, length) }
}

/// Clears the record of the last error message.
#[unsafe(no_mangle)]
pub extern "C" fn ZCASH_zcashlc_clear_last_error() {
...
///   of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_init_data_database(
    db_data: *const u8,
    db_data_len: usize,
    seed: *const u8,
    seed_len: usize,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_list_accounts(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
) -> *mut ffi::Accounts {
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_account(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_create_account(
    db_data: *const u8,
    db_data_len: usize,
    seed: *const u8,
    seed_len: usize,
...
///   you are finished using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_import_account_ufvk(
    db_data: *const u8,
    db_data_len: usize,
    ufvk: *const c_char,
    treestate: *const u8,
...
///   of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_is_seed_relevant_to_any_derived_account(
    db_data: *const u8,
    db_data_len: usize,
    seed: *const u8,
    seed_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_delete_account(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    account_uuid_bytes: *const u8,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_current_address(
    db_data: *const u8,
    db_data_len: usize,
    account_uuid_bytes: *const u8,
    network_id: u32,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_single_use_taddr(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    account_uuid_bytes: *const u8,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_next_available_address(
    db_data: *const u8,
    db_data_len: usize,
    account_uuid_bytes: *const u8,
    network_id: u32,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_list_transparent_receivers(
    db_data: *const u8,
    db_data_len: usize,
    account_uuid_bytes: *const u8,
    network_id: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_verified_transparent_balance(
    db_data: *const u8,
    db_data_len: usize,
...
///   function call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_verified_transparent_balance_for_account(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    account_uuid_bytes: *const u8,
...
/// - The memory referenced by `address` must not be mutated for the duration of the function call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_total_transparent_balance(
    db_data: *const u8,
    db_data_len: usize,
    address: *const c_char,
    network_id: u32,
...
///   function call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_total_transparent_balance_for_account(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    account_uuid_bytes: *const u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_memo(
    db_data: *const u8,
    db_data_len: usize,
    txid_bytes: *const u8,
    output_pool: u32,
...
pub unsafe extern "C" fn ZCASH_zcashlc_seed_fingerprint(
    seed: *const u8,
    seed_len: usize,
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_rewind_to_height(
    db_data: *const u8,
    db_data_len: usize,
    height: u32,
    network_id: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_put_sapling_subtree_roots(
    db_data: *const u8,
    db_data_len: usize,
    start_index: u64,
...
/// - The memory referenced by `roots` must not be mutated for the duration of the function call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_put_orchard_subtree_roots(
    db_data: *const u8,
    db_data_len: usize,
    start_index: u64,
    roots: *const ffi::SubtreeRoots,
...
///   documentation of `pointer::offset`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_update_chain_tip(
    db_data: *const u8,
    db_data_len: usize,
    height: i32,
    network_id: u32,
...
///   documentation of `pointer::offset`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_fully_scanned_height(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
) -> i64 {
...
///   documentation of `pointer::offset`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_max_scanned_height(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_wallet_summary(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    confirmations_policy: ffi::ConfirmationsPolicy,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_suggest_scan_ranges(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
) -> *mut ffi::ScanRanges {
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_scan_blocks(
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_put_utxo(
    db_data: *const u8,
    db_data_len: usize,
    txid_bytes: *const u8,
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_init_block_metadata_db(
...
///   function is invoked.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_write_block_metadata(
    fs_block_db_root: *const u8,
    fs_block_db_root_len: usize,
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_rewind_fs_block_cache_to_height(
    fs_block_db_root: *const u8,
    fs_block_db_root_len: usize,
    height: i32,
) -> bool {
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_latest_cached_block_height(
    fs_block_db_root: *const u8,
    fs_block_db_root_len: usize,
) -> i32 {
    let res = catch_panic(|| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_decrypt_and_store_transaction(
    db_data: *const u8,
    db_data_len: usize,
    tx: *const u8,
    tx_len: usize,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_propose_transfer(
    db_data: *const u8,
    db_data_len: usize,
    account_uuid_bytes: *const u8,
    to: *const c_char,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_propose_send_max_transfer(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    account_uuid_bytes: *const u8,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_propose_transfer_from_uri(
    db_data: *const u8,
    db_data_len: usize,
    account_uuid_bytes: *const u8,
...
#[unsafe(no_mangle)]
pub extern "C" fn ZCASH_zcashlc_branch_id_for_height(height: i32, network_id: u32) -> i32 {
    let res = catch_panic(|| {
        let network = parse_network(network_id)?;
...
pub unsafe extern "C" fn ZCASH_zcashlc_string_free(s: *mut c_char) {
    if !s.is_null() {
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_propose_shielding(
    db_data: *const u8,
    db_data_len: usize,
    account_uuid_bytes: *const u8,
    memo: *const u8,
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_create_proposed_transactions(
    db_data: *const u8,
    db_data_len: usize,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_create_pczt_from_proposal(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    proposal_ptr: *const u8,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_redact_pczt_for_signer(
    pczt_ptr: *const u8,
    pczt_len: usize,
) -> *mut ffi::BoxedSlice {
    let res = catch_panic(|| {
...
///   of `pointer::offset`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_pczt_requires_sapling_proofs(
    pczt_ptr: *const u8,
    pczt_len: usize,
) -> bool {
    let res = catch_panic(|| {
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_add_proofs_to_pczt(
    pczt_ptr: *const u8,
    pczt_len: usize,
    spend_params: *const u8,
    spend_params_len: usize,
...
///   when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_extract_and_store_from_pczt(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_set_transaction_status(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
    txid_bytes: *const u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_transaction_data_requests(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_fix_witnesses(
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
) {
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_create_tor_runtime(
    tor_dir: *const u8,
    tor_dir_len: usize,
) -> *mut TorRuntime {
    let res = catch_panic(|| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_tor_runtime(ptr: *mut TorRuntime) {
    if !ptr.is_null() {
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_isolated_client(
...
/// - `tor_runtime` must not be passed to two FFI calls at the same time.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_set_dormant(
    tor_runtime: *mut TorRuntime,
...
///   returned pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_http_get(
    tor_runtime: *mut TorRuntime,
    url: *const c_char,
...
///   returned pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_http_post(
    tor_runtime: *mut TorRuntime,
    url: *const c_char,
    headers: *const ffi::HttpRequestHeader,
    headers_len: usize,
...
/// - `tor_runtime` must not be passed to two FFI calls at the same time.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_get_exchange_rate_usd(
    tor_runtime: *mut TorRuntime,
) -> ffi::Decimal {
    // SAFETY: Callers would have to do the following for unwind safety (#194):
    // - using `*mut TorRuntime` and respecting mutability rules on the Swift side, to
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_connect_to_lightwalletd(
    tor_runtime: *mut TorRuntime,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_free_tor_lwd_conn(ptr: *mut tor::LwdConn) {
    if !ptr.is_null() {
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_get_info(
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_latest_block(
    lwd_conn: *mut tor::LwdConn,
    height_ret: *mut u32,
) -> *mut ffi::BoxedSlice {
    // SAFETY: We ensure unwind safety by:
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_fetch_transaction(
    lwd_conn: *mut tor::LwdConn,
    txid_bytes: *const u8,
    height_ret: *mut u64,
) -> *mut ffi::BoxedSlice {
...
///   documentation of pointer::offset.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_submit_transaction(
    lwd_conn: *mut tor::LwdConn,
    tx: *const u8,
    tx_len: usize,
) -> bool {
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_get_tree_state(
    lwd_conn: *mut tor::LwdConn,
    height: u32,
) -> *mut ffi::BoxedSlice {
    // SAFETY: We ensure unwind safety by:
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_update_transparent_address_transactions(
    lwd_conn: *mut tor::LwdConn,
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_fetch_utxos_by_address(
    lwd_conn: *mut tor::LwdConn,
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
...
///   pointer when done using it.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ZCASH_zcashlc_tor_lwd_conn_check_single_use_taddr(
    lwd_conn: *mut tor::LwdConn,
    db_data: *const u8,
    db_data_len: usize,
    network_id: u32,
